...
export const WEBSOCKET_BELLS = '🛎 WEBSOCKET_BELLS'
...
export const BASKET_UPLOAD_PROGRESS = '🏃 BASKET_UPLOAD_PROGRESS'
...
export const BELLS_REQUEST = '🛎 BELLS_REQUEST'
export const BELLS_SUCCESS = '✅ BELLS_SUCCESS'
